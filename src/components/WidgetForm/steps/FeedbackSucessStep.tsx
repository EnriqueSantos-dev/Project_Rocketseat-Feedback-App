  ...
  return (
    <>
      ...
      <button
        ...
        className='py-2 px-6 my-6  rounder-md border-transparent bg-zinc-800 text-sn leading-6  transition-colors hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 rounded-md '>
        Quero enviar outro
      </button>
    </>
  );
